...
void setup() {
  ...
  WiFi.mode(WIFI_STA);  // Ensure WiFi in Station/Client Mode
	...
	initCloudConfig("HostName=MakerDen.azure-devices.net;DeviceId=MqttDevice;SharedAccessKey=ZH1hd5b0fDRuEZHG0P8LwRF74yvZ9QrwiQlHaOsJomg=", "dgWAP", "VisualStudio2005", "Melbourne");
